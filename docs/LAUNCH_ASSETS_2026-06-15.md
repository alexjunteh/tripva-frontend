# Tripva Launch Assets - June 15, 2026
...
**Short description:** Tripva turns a destination idea into a full day-by-day itinerary with hotels, food, transport, tickets, budget, maps, and live travel alerts.
...
Tripva starts from one prompt and builds a complete trip dashboard: daily route, hotels, restaurants, tickets, budget, maps, photo spots, and shareable links. The goal is not just "AI suggestions" - it is a plan you can actually use while travelling.

What is live today:
- 30-second itinerary generation
- Shareable trip dashboards
- Saved trips
- Transport, hotel, activity, and flight-link helpers
...
The backend is Node/Vercel. Trips are stored as secret GitHub Gists. The frontend is static HTML with PWA support. There is also a small Cloudflare worker for dynamic OG previews on shared trip links.
...
I am launching Tripva on June 15.

It is an AI trip planner that creates a complete itinerary dashboard instead of a plain text answer. The plan includes daily route, hotels, budget, activities, transport notes, booking links, and shareable trip pages.
...
What is done:
- Working trip generator
- Saved/shareable trips
- Demo trip
- PWA
- Blog
- 10 SEO itinerary pages
- Affiliate link foundation
